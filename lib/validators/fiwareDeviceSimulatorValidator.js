  ...
  if (Array.isArray(simulationConfiguration.devices) && simulationConfiguration.devices.length) {
    ...
    if (isUltraLightHTTPDevice(simulationConfiguration.devices)) {
      if (!simulationConfiguration.iota.ultralight) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No IoT Agent UltraLight configuration ' +
          'information (the \'iota.ultralight\' property is mandatory)'));
      }
      if (!simulationConfiguration.iota.ultralight.http) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No IoT Agent UltraLight HTTP configuration ' +
          'information (the \'iota.ultralight.http\' property is mandatory)'));
      }
      if (!simulationConfiguration.iota.ultralight.http.host) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No UltraLight HTTP host in the IoT Agent ' +
      ...
      if (!simulationConfiguration.iota.ultralight.http.port) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No UltraLight HTTP port in the IoT Agent ' +
      ...
      if (!simulationConfiguration.iota.ultralight.mqtt) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No IoT Agent UltraLight MQTT configuration ' +
          'information (the \'iota.ultralight.mqtt\' property is mandatory)'));
      }
      if (!simulationConfiguration.iota.ultralight.mqtt.protocol) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No UltraLight MQTT protocol in the IoT Agent ' +
      ...
      if (!simulationConfiguration.iota.ultralight.mqtt.host) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No UltraLight MQTT host in the IoT Agent ' +
      ...
      if (!simulationConfiguration.iota.ultralight.mqtt.port) {
        return callback(new fdsErrors.SimulationConfigurationNotValid('No UltraLight MQTT port in the IoT Agent ' +
...
function validateDeviceConfiguration(deviceConfiguration, index, callback) {
  ...
  if (!deviceConfiguration.api_key) {
    return callback(new fdsErrors.SimulationConfigurationNotValid('The devices configuration information ' +
      'at array index position ' + index + ' should include an api_key properties'));
  }
